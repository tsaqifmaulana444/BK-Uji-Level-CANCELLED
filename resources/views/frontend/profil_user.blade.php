        ...
        <div class="px-6 py-8">
            <div class="max-w-4xl mx-auto">
                <div class="bg-white rounded-3xl p-8 mb-5">
                    <h1 class="text-3xl font-bold mb-10">Profil Lengkap {{ $user->name }}</h1>
                    <div class="ml-4 mt-4">
                        <form action="{{ route('update_profil', $user->id) }}" method="post"
                            ...
                            <div class="flex mt-4">
                                <div class="w-full mr-3">
                                    ...
                                    <input type="password" id="small-input" value="" name="password"
                                        class="block w-[30vw] p-3 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500">
                                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-300 capitalize"
                                        id="file_input_help">Masukkan password lama (jika tidak ingin mengganti)</p>
                                </div>
                                <div class="w-full">
                            ...
                            <div class="w-full flex">
                                <div class="w-full">
                                    ...
                                    <input type="text" id="small-input" value="{{ $user->no_identitas }}"
                                        name="no_identitas"
                                        class="block w-[30vw] p-3 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500">
                                </div>
